        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style">
                            <li>
                                <h4 class="page-title">Home Package Detail<small style="font-size: 15px"> Tambah Package Detail</small></h4>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Tambah </strong>Package Detail</h2>
                        </div>
                        <div class="body">
                            <form  method="POST" action="" autocomplete="OFF" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group <?php echo $validationErrorsRenderer->renderToAdminHtml('package_image') == '' ? '' : ' error' ?>" >
                                            <div class="form-line">
                                                <div class="file-field input-field">
                                                    <div class="btn">
                                                        <span>File</span>
                                                             <input type="file" name="package_image" id="imgInp">
                                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        ...
                                        <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="process" value="add_homepackagedetail">TAMBAH PACKAGE DETAIL</button>
                                    </div>
                                </div>
                            </form>
                        </div>
