                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style">
                            <li>
                                <h4 class="page-title">Home Syarat dan Ketentuan<small style="font-size: 15px"> Tambah Detail</small></h4>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <form  method="POST" action="" autocomplete="OFF" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="form-line">
                                                <select class="browser-default" name="sk_category">
                                                    ...
                                                    <?php foreach($homeskDomainArray as $homeskDomain) :?>
                                                        <option value="<?php echo $homeskDomain->getCategory(); ?>"><?php echo $homeskDomain->getCategory(); ?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea class="ckeditor" id="editor-standar" name="sk_description" style="height: 500px"></textarea>
                                            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        ...
                                        <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="process" value="add_homeskdetail">TAMBAH DETAIL</button>
                                    </div>
                                </div>
                            </form>
                        </div>
