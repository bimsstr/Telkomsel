        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style">
                            <li>
                                <h4 class="page-title">Home Package Blog<small style="font-size: 15px"> Tambah Package Blog</small></h4>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Tambah </strong>Package Blog</h2>
                        </div>
                        <div class="body">
                            <form  method="POST" action="" autocomplete="OFF" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea class="ckeditor" id="editor-standar" name="package_description" style="height: 200px"></textarea>
                                            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea class="ckeditor" id="editor-standar" name="package_sk" style="height: 200px"></textarea>
                                            </div>
                                        ...
                                        <div class="form-group <?php echo $validationErrorsRenderer->renderToAdminHtml('package_image') == '' ? '' : ' error' ?>" >
                                            <div class="form-line">
                                                <div class="file-field input-field">
                                                    ...
                                                    <img id='img-upload1' style="height: 40%" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        ...
                                        <button type="submit" class="btn btn-primary m-t-15 waves-effect" name="process" value="add_homepackageblog">TAMBAH PACKAGE DETAIL</button>
                                    </div>
                                </div>
                            </form>
                        </div>
