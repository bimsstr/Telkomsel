...
class Add extends AdminController
{
    ...
    {
        if ($this->request->getPost('process') == 'add_homesk')
        {
            $this->addProcess();
            return;
        }
    ...
    private function addProcess()
    {
        ...
        $this->homeskDataSource->insert($homeskDomain);
    ...
    ");
        ...
        $this->breadcrumbArray = array(
            ...
            array('Home SK',$this->urlBuilder->build('setting-home-sk','',FALSE),''),
            array('Add','','')
        );

        //DATA
        $homeskcategoryDomainArray = $this->homeskDataSource->getAllHomeSKDomain();

        $this->overideViewVariable(array(
            'homeskDomain' => $this->homeskDomain,
            'homeskcategoryDomainArray' => $homeskcategoryDomainArray,
        ));

        $this->load->view('setting_home_sk/add', $this->viewVariable);
    }
}
