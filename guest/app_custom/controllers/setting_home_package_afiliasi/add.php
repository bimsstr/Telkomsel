...
class Add extends AdminController
{
    ...
    {
        if ($this->request->getPost('process') == 'add_homepackageafiliasi')
        {
            $this->addProcess();
            return;
        }
    ...
    private function addProcess()
    {
        ...
        if ($package_image['name'] != '') {
            ...
            $package_image['name'] = "imgpackage".date('Y-m-d')."_".date('His').$ext;
             if ($package_image['type'] != 'image/jpeg' AND $package_image['type'] != "image/png") {
                 ...
                 $this->redirect('setting-home-package-afiliasi/add');
                 return;
             }
        }
        ...
        $this->homepackageafiliasiDataSource->insert_hpa($homepackageafiliasiDomain);
    ...
    ");
        ...
        $this->breadcrumbArray = array(
            ...
            array('Home Package Afiliasi',$this->urlBuilder->build('setting-home-package-afiliasi','',FALSE),''),
            array('Add','','')
        );
        ...
        $this->load->view('setting_home_package_afiliasi/add', $this->viewVariable);
    }
}