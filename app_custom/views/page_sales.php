...
<!-- =========== Start of Hero ============ -->
 <!--hero section start-->
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-9 col-lg-10">
                    <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                        ...
                        <h1 class="text-white mb-0"><?php echo $salesTitleDomain->getTitle(); ?></h1>
                ...
                <div class="col-lg-12 col-md-8">
                    ...
                    <div class="post-wrapper">
                        <div class="post-header">
                            <h4 class="text-center">Daftar Sales <span style="color: red"> Indihome Jogja </span></h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="post-wrapper">
                        ...
                        <div class="post-header">
                            ...
                            <select class="browser-default" name="sortby" style="height: 30px; width: 250px" >
                                ...
                                <!--<option value="bintang">Star / Feedback</option>-->
                            </select>
    ...
    <section class="team-member-section" style="padding-top: 30px;padding-bottom: 50px">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-team-member position-relative my-lg-3 my-md-3 my-sm-0">
                        ...
                        <div class="team-info text-white rounded d-flex flex-column align-items-center justify-content-center">
                            ...
                            <a href="https://wa.me/<?php echo $hp;?>?text=Halo%20Indihome%20Jogja.%20Saya%20ingin%20berlanggan%20Indihome%20Jogja.%20Apakah%20bisa%20dibantu%20untuk%20informasi%20lebih%20lanjut%20?" target="_blank" class="btn app-store-btn">CHAT SEKARANG!</a>
                        </div>
                    </div>
                </div>
                <?php endforeach;?>
