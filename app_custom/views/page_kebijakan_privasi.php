            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7">
                    <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                        <h1 class="text-white mb-0">KEBIJAKAN PRIVASI</h1>
                        <p>Kebijakan Privasi Layanan Indihome Jogja</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="col-12 col-md-10 col-lg-7 col-xl-6 mx-auto">
                <div class="section-title reveal text-center mb-20">
                    <br>
                    <br>
                    <h3 class="font-w-400">KEBIJAKAN <strong class="color-primary">PRIVASI</strong></h3>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <blockquote class="card-body" style="padding-right:50px; padding-left: 50px">
                            <?php if (count($homekptitleDomainArray) == 0) : ?>
                                <p>tidak ada data</p>
                            <?php endif; ?>
                            <?php foreach($homekptitleDomainArray as $homekptitleDomain) :?>
                                <?php echo $homekptitleDomain->getDescription(); ?>  
                            <?php endforeach;?>
                            <?php if (count($homekpdetailDomainArray) == 0) : ?>
                                <p>tidak ada data</p>
                            <?php endif; ?>
                            <?php foreach($homekpdetailDomainArray as $namaCategory => $homekpListDomain) :?>
                           ...
                           <?php foreach($homekpListDomain as $homekpdetailDomain) : ?>   
                                    <?php 
                                        $desc = $homekpdetailDomain->getDescription();   
                                        $list = explode(PHP_EOL, $desc);?>
