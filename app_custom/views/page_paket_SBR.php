            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-12">
                    <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                        <h1 class="text-white mb-0">INDIHOME Paket SBR Indihome StaySafe </h1>
                        <p>Yuk! Lihat Paket Indihome Paket SBR Indihome StaySafe Yang Sesuai Kebutuhan Kamu</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="pricing" class="package-section mt-4">
        <div class="container">
            <div class="row justify-content">
                ...
                <div class="col-lg-4 col-md" style="margin-top:100px">
